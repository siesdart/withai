  ...
  ko: {
    game: {
      ...
      phasePanel: {
        ...
        eliminatedObserver: '탈락했습니다. 각 단계와 결과를 계속 지켜볼 수 있어요.',
        chooseNominee: '변론할 사람을 지목하세요',
        selectAliveParticipant: '참가자 목록에서 생존자를 선택하세요.',
        finalDefence: '최후 변론',
        nomineeHasFloor: '{{participantName}}님이 지목되어 변론 중입니다.',
        nomineePreparingDefence: '지목된 참가자가 최후 변론을 준비하고 있습니다.',
        verdictFor: '{{participantName}}님 처분 투표',
        eliminate: '탈락시키기',
        spare: '살려두기',
        nightPrompt: {
          Mafia: '제거할 표적을 선택하세요',
      ...
      records: {
        ...
        verdictEliminated: '{{dayNumber}}일차: {{participantName}}님이 탈락했습니다.',
        verdictTied: '{{dayNumber}}일차: {{participantName}}님이 찬반 투표 동률로 살아남았습니다.',
        verdictNoMajority:
          '{{dayNumber}}일차: 탈락 찬성이 과반수에 이르지 않아 {{participantName}}님이 살아남았습니다.',
        ...
        phaseStarted: '{{dayNumber}}일차 {{phase}} 단계가 시작되었습니다.',
        ...
        nightNoDeath: '{{dayNumber}}일차: 밤사이 탈락한 참가자가 없습니다.',
        nightParticipantEliminated:
          '{{dayNumber}}일차: {{participantName}}님이 밤사이 탈락했습니다.',
        discussionLimitReached:
        ...
        verdictTotals: '탈락 {{eliminateVotes}}표, 생존 {{spareVotes}}표.',
