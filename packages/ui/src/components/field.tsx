...
/* oxlint-disable jsx-a11y/prefer-tag-over-role, react/no-array-index-key -- shadcn Field supports arbitrary grouped controls and de-duplicates validation messages. */
